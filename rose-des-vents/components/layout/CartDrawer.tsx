    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-wool">
          <span className="font-serif text-lg tracking-[0.15em]">PANIER</span>
          <button
            onClick={closeCart}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 mt-2">
                      <button
                        ...
                        className="w-7 h-7 border border-wool flex items-center justify-center text-xs hover:border-forest transition-colors"
                      >
                        −
                      </button>
