      ...
      >
        ...
        <nav className="p-6 flex flex-col gap-6">
          <Link
            ...
            onClick={onClose}
            className="text-sm uppercase tracking-[0.2em] text-charcoal hover:text-forest transition-colors"
          >
            Tuques
          </Link>
          <Link
          ...
          <Link
            href="/"
            onClick={onClose}
            className="text-sm uppercase tracking-[0.2em] text-charcoal/60 hover:text-forest transition-colors"
          >
            Accueil
          </Link>
        </nav>
